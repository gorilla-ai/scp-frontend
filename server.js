...
const cfg = _.assign({
  ...
  //apiPrefix: 'http://172.18.0.91:8080/SCP', //Bomin's machine
  ...
  session: {
    ...
    //rights: ["Module_Common"],
    //rights: ["Module_Dashboard", "Module_Common", "Module_Soc", "Module_Account", "Module_Edge", "Module_Service", "Module_Auth_System", "Module_Tenant_System", "Module_Depart_System"],
    name: 'ryan',
    account: 'ryanchen',
