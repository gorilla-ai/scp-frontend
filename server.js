...
const cfg = _.assign({
  ...
  contextRoot: '',
  apiPrefix: 'http:\//172.18.0.119/ChewbaccaWeb', //Prod environment
  //apiPrefix: 'http:\//192.168.11.91/ChewbaccaWeb', //Test environment
  ...
  app: {
    searchFields: {
      ...
      //alert: ["alertInformation.type", "alertInformation.indexName", "alertInformation.id", "trailName", "trailSource", "alert.signature_id", "ipSrc", "portSrc", "ipDst", "portDst", "timestamp", "lastPacket", "dstSvcname", "dstHostname", "srcSvcname", "srcHostname", "createTimestamp", "projectName", "sessionId", "_tableMenu_", "_eventDttm_", "srcIp", "srcPort", "destIp", "destPort"],
