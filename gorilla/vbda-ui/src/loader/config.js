...
export function processAll(cfg, ds, lng='en') {
    ...
    _.forEach(data_sources, (dsCfg, dsId)=>{
        ...
        _.forEach(data_types, dtCfg=>{
            ...
            if(_.has(propsLocale, ['__dataType', 'display_name']) && !_.isNil(propsLocale['__dataType']['display_name']))
                result.dt[dtId].display_name = _.get(propsLocale, ['__dataType', 'display_name'])
