...
module.exports = function(grunt) {
    ...
    grunt.registerTask('default', ['webpack:watch', 'build-less', /*'eslint',*/'build-locales', 'modernizr:dist', 'watch'])
    grunt.registerTask('dev', ['webpack:dev', 'build-less', /*'eslint',*/'build-locales', 'modernizr:dist'])
    grunt.registerTask('prod', ['env:prod','webpack:prod', 'build-less', /*'eslint',*/'build-locales', 'modernizr:dist'])
};
