...
var log = require('loglevel').getLogger('gis/symbols/polygon');
/**
...
var Polygon = /*#__PURE__*/function (_GisSymbol) {
  _inherits(Polygon, _GisSymbol);

  var _super = _createSuper(Polygon);

  function Polygon(id, props, selected, selectedProps) {
    _classCallCheck(this, Polygon);

    return _super.call(this, id, 'polygon', props, selected, selectedProps); // supported props other than leaflet options: tooltip, popup, latlng, label, icon
  }
  /*
  ...
  _createClass(Polygon, [{
    ...
    value: function _createLayer(props) {
      ...
      this._layer = _leaflet["default"].polygon(props.latlng, options);
      return this._layer;
    }
  }]);
