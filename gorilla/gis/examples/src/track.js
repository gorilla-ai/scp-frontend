      ...
      <div className='c-flex c-gis'>
        ...
        <div className='c-flex fdc map-func'>
          <div className='c-flex fdc'>
            <h4>Set Map</h4>
            <button onClick={this.changeLayout}>Standard / Track</button>
            ...
            <button onClick={this.setTrackStyle}>Set Track Style</button>
          </div>
          <div className='c-flex fdc'>
            <h4>Manipulate</h4>
            ...
            <button onClick={this.hideSymbol}>Hide Selected</button>
            <button onClick={this.zoomToFitSelection}>Set View To Selected</button>
            <button onClick={this.filterTrack.bind(this, { id: 'mobile_0912345678' })}>Filter Track 1</button>
            <button onClick={this.filterTrack.bind(this, { id: 'robbery_track_2' })}>Filter Track 2</button>
            <button onClick={this.filterTrack.bind(this, { type: 'track' })}>Show All Track</button>
