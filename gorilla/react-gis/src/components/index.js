 ...
 */
class ReactGis extends React.Component {
    static propTypes = {
        id: PropTypes.string,
        _ref: PropTypes.func,
        ...
        truncateLabels: PropTypes.object,
        data: PropTypes.arrayOf(PropTypes.object),
        show: PropTypes.arrayOf(PropTypes.string),
        timeRange: PropTypes.arrayOf(PropTypes.number),
        selected: PropTypes.arrayOf(PropTypes.string),
        baseLayers: PropTypes.objectOf(PropTypes.shape({
            label: PropTypes.string,
            size: PropTypes.shape({ // for area map
        ...
        dragModes: PropTypes.arrayOf(PropTypes.oneOf(DRAG_MODES)),
        dragMode: PropTypes.oneOf(DRAG_MODES),
        onDragModeChange: PropTypes.func,
        regionTypes: PropTypes.arrayOf(PropTypes.oneOf(REGION_TYPES)),
        regionType: PropTypes.oneOf(REGION_TYPES),
        onRegionTypeChange: PropTypes.func,
        symbolOptions: PropTypes.array,
        trackOptions: PropTypes.array,
        heatmapOptions: PropTypes.object,
        contourOptions: PropTypes.object,
        ...
        resetViewOnFilter: PropTypes.bool,
