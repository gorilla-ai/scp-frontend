...
//     All rights reserved.
//     KeyLines v4.6.0-9745 professional
//
declare module KeyLines {
  ...
  interface Glyph {
    ...
    u?: string,
    /** Applies to nodes only - does not apply to links or bubbles. Set to true to extend the width of the glyph circle to form a rounded rectangle. Default: false. */
    w?: boolean
  }
  ...
  interface ComboDefinition {
    ...
    style?: NodeStyle,
    /** The style of the open combo node using the standard node property names. If not specified, the style will be the default for open combos. */
  ...
  interface Graph {
    ...
    * @returns A dictionary whose properties are the ids of the nodes in the graph. The values are the closeness values. */
    ...
    /** The clusters function groups nodes in the graph into a set of clusters, and then returns an object describing them.
