...
class SoarLogTesting extends Component {
  ...
  render() {
    ...
    const actions = {
      cancel: {text: t('txt-close'), className: 'standard', handler: this.props.setSourceLogs.bind(this, this.state.sourceLogs)},
    };
...
SoarLogTesting.propTypes = {
  ...
  setSourceLogs: PropTypes.func.isRequired,
