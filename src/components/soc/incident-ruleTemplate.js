...
import MarkInput from "../common/mark-input";
...
class IncidentRuleTemplate extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            incidentRule: {
                dataFieldsArr: ['accountQueryDTO.name' ,'title', 'severity', 'impact',  'category', 'eventDescription', 'accountQueryDTO.module' , '_menu'],
                dataFields: [],
                dataContent: [],
                sort: {
                    field: 'severity',
