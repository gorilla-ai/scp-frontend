                                    ...
                                    if (val === 'updateDttm' || val === 'createDttm') {
                                        ...
                                        return (
                                            <div className='table-menu menu active'>
                                                <i className='fg fg-eye' title={t('txt-view')}
                                                   onClick={this.toggleContent.bind(this, 'view', allValue)}/>
                                                {/*<i className='fg fg-trashcan'  title={t('txt-delete')} onClick={this.openDeleteMenu.bind(this, allValue)} />*/}
                                            </div>
                                        )
                                    } else {
        ...
        return (
            <div className='main-content basic-form'>
                ...
                <div className='content-header-btns'>
                    {activeContent === 'view' &&
                    <div>
                        <Button variant='outlined' color='primary' className='standard btn list'
                        ...
                        <Button variant='outlined' color='primary' className='standard btn edit'
                                onClick={this.toggleContent.bind(this, 'edit')}>{t('txt-edit')}</Button>
                    </div>
                    }
                </div>
                ...
                <footer>
                    <Button variant='outlined' color='primary' className='standard'
                            onClick={this.toggleContent.bind(this, pageType)}>{t('txt-cancel')}</Button>
                    <Button variant='contained' color='primary'
                            onClick={this.handlePatternSubmit}>{t('txt-save')}</Button>
                </footer>
                }
            </div>
        )
